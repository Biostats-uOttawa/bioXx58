...
Assignments should be done using Quarto files (.qmd including R + markdown code) using the template provided and generate a html output.
You must submit a single html copy of your assignments (generated from your .qmd document) with all students names and ID listed at the top (submit a single copy for the group).
Late assignments will be penalized 10% per day or part thereof for a mximum of 3 days after which a grade of 0 will be given to that assignment.
